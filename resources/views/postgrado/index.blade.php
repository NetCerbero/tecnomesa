...
<div class="d-flex justify-content-end my-2">
	<a class="btn btn-primary" href="{{ route('postgrado.create') }}">Registrar</a>
</div>
<div class="card">
                  <div class="card-header">
                    <div class="card-title">
                        <div class="d-flex bd-highlight mb-3">
                          <div class="p-2 bd-highlight">Gestión de postgrado</div>
                        ...
                        <tbody>
                            @foreach ($postgrados as $postgrado)
	                            @php
          					         	...
          					         	@endphp
                                <tr class="gradeX">
                                  <td>{{ $postgrado->titulado->egresado->registro }}</td>
