...
@section('title')
 ...
 @endphp
<h2>Egresado {{ $datos['datos']['nombre'] }}</h2>
@endsection
@section('content')
<div class="row">
    <div class="col">
        ...
        <div class="card card-default">
            <div class="card-header">Edicion Usuario</div>
            <div class="card-body">
	            <form method="POST" action="{{route('egresado.update',$graduacion->id)}}" >
	                @csrf
                    @method('PUT')
	                <div class="form-group mb-0">
	                    ...
	                    <input name="registro" id="registro" value="{{ $graduacion->egresado->registro }}" type="number" placeholder="Ingrese el código" class="buscador">
	                ...
	                <div class="form-row mt-2">
	                	<div class="form-group col-md-4 col-12 col-sm-6">
		                    ...
		                    <input disabled name="nombre" value="{{ $datos['datos']['nombre'] }}" class="form-control input-block clear-input-search" type="text" placeholder="Nombre completo del egresado">
		                </div>
		                ...
		                <div class="form-group col-md-4 col-12 col-sm-6">
		                    ...
		                    <input name="titulo" value="{{ $graduacion->titulo }}"class="form-control clear-input trabajo_tesis" type="text" placeholder="Ingrese el título del proyecto">
		                </div>
